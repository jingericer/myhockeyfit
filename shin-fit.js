(() => {
  ...
  function render(focus=true) {
    const screens=[
      ...
      ()=>'<h2 tabindex="-1">Where is your skate tongue?</h2><p>The yellow part is the skate tongue. Neither choice means a higher playing level.</p><a href="assets/shin-tongue-guide.png" target="_blank" rel="noopener" aria-label="Open larger tongue comparison illustration"><img class="sg-illustration" src="assets/shin-tongue-guide.png" alt="Left: yellow skate tongue overlaps outside the shin pad. Right: the shin pad covers the upper yellow tongue."></a>'+radio('tongue',[['outside','Tongue outside the shin pad'],['tucked','Tongue under the shin pad'],['unsure','Not sure yet']],data.tongue),
